...
# ---- OPTIONS
FFOPTIONS = # Do not specify any options
# FFOPTIONS = --expandstroke # Enable stroke expansion (emboleden a bit)
...
$(UNHINTED_OUTPUT): ./scripts/code8903.pe $(TMP_JISZ8903) $(TMP_ROUNDEDMP)
	fontforge ./scripts/code8903.pe $(TMP_JISZ8903) $(TMP_ROUNDEDMP) $(UNHINTED_OUTPUT)

$(TMP_JISZ8903): ./scripts/JISZ8903.pe $(SOURCE_JISZ8903)
	fontforge ./scripts/JISZ8903.pe $(SOURCE_JISZ8903) $(TMP_JISZ8903)
